...
class Frame extends JFrame{
  ...
  public Frame(){
    ...
    zoom.addActionListener(new ActionListener(){
      public void actionPerformed(ActionEvent ae){
        ...
        if( z_flag ){
          ...
          Frame.this.zoom.setText("100%表示");
          panel.resetPoint();
          panel.repaint();
        }
      }
    ...
    select.addActionListener(new ActionListener(){
      public void actionPerformed(ActionEvent ae){
        Input input = new Input(Frame.this);
    ...
    save.addActionListener(new ActionListener(){
      public void actionPerformed(ActionEvent ae){
        Output output = new Output(Frame.this,orgWidth,orgHeight,set_time/10,panel.returnImage());
      }
    });
